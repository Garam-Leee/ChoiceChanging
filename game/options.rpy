...
define config.name = _("Choice Changing")
...
#define build.name = "ChoiceChanging"
...
define config.save_directory = "ChoiceChanging-1607182692"
...
init python:
    ...
    build.directory_name = "Choice_Changing-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "Choice_Changing"
